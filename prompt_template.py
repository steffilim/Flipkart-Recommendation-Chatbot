...
Given the user's query {question} and the user's chat history {history}, identify the user's specific needs or preferences.
This includes identifying keywords related to product types, brands, or specifications that are part of the user's intent.

If the product can be found, list all relevant keywords, separating them with commas. Focus on nouns and verbs, emphasizing brands and specifications.
If the product cannot be found, the output should be "None".
If the user is making a greeting, the output should be "Greeting".

Example Responses:
- For a laptop query with a focus on "Dell, 16GB RAM", return: "laptop, Dell, 16GB RAM".
- If the user greets the bot, return: "Greeting".
- If the item is not available, return: "None".
"""